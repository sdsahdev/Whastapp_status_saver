...
import com.example.whastapp_saver_two.FullViewActivity;
import com.example.whastapp_saver_two.GalleryActivity;
import com.example.whastapp_saver_two.R;
import com.example.whastapp_saver_two.WhatsappActivity;
import com.example.whastapp_saver_two.adapters.FileListAdapter;
import com.example.whastapp_saver_two.all_interfaces.FileListClickInterface;
import com.example.whastapp_saver_two.databinding.FragmentHistoryBinding;
...
//    private GalleryActivity activity;
    ...
    public void onAttach(@NotNull Context _context) {
        ...
        activity = (WhatsappActivity) _context;
    }
    @Override
    ...
    public void onResume() {
        super.onResume();
        activity = (WhatsappActivity) getActivity();
        getAllFiles();
