...
import com.example.whastapp_saver_two.databinding.ActivityWhatsappBinding;
import com.example.whastapp_saver_two.databinding.DialogWhatsappPermissionBinding;
import com.example.whastapp_saver_two.fragments.WhatsAppDowndlededFragment;
import com.example.whastapp_saver_two.fragments.WhatsappImageFragment;
import com.example.whastapp_saver_two.fragments.WhatsappQImageFragment;
...
//                        break;
                    ...
                    case R.id.mWab:
                        ...
                        case R.id.mShare:
                            ...
                            shareMessage = shareMessage + "https://play.google.com/store/apps/details?id=" + com.example.whastapp_saver_two.BuildConfig.APPLICATION_ID;
...
//                        break;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new WhatsAppDowndlededFragment(), "saved");
    ...
    class LoadAllFiles extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String fileUrl) {
            ...
            adapter.addFragment(new WhatsappQVideoFragment(fileArrayList), getResources().getString(R.string.saved));
